...
<!-- I had goosebumps of marvel when I stepped out of the cinema. -->
...
The first important scene in The Matrix is when Neo, the computer hacker protagonist, first meets Trinity. 
...
It was dull to memorize algorithms and endlessly apply them to variations of the same, poorly motivated equations.
...
One morning he kept energetically tapping his calculator but refused to reveal his doings.
As he finally and triumphantly announced his demo, we gathered over his calculator like a flock of gulls. 
He unveiled a smooth running animation resembling the twisting of DNA. 
...
Our teacher, [Magnus Fontes](https://institut.roche.com/member/magnus-fontes/), was brilliant.
<!-- With wits, he filled our minds with a universe of vectors and linear transformations.  -->
With wits, he filled our minds with vectors and linear transformations, lo and behold, represented by *matrices*.
He gave a motivation lecture, where he illustrated how his own research (in [harmonic analysis](https://en.wikipedia.org/wiki/Harmonic_analysis)) applies to brewing of beer and to synthesizers in electronic music. 
...
It's a whisper hinting at a world of possibilities.

The course in Linear Algebra transfigured my view of mathematics. 
It wasn't any longer about memorizing algorithms. Linear Algebra is a self-contained theory.
It's abstract, yet concrete because it's geometric.
It evokes mental pictures.

<p style="text-align: center;">~</p>

Twenty years later, [Milo Viviani](https://www.sns.it/it/persona/milo-viviani) and I began to study how geometry reveals itself in the equations of hydrodynamics, formulated by [Leonhard Euler](https://en.wikipedia.org/wiki/Leonhard_Euler) in 1757.
Considerable progress has been made for these equations, but nevertheless they are far from fully understood. 
The more mathematicians learn about them, the more peculiar their solutions appear to be.

[Vladimir Arnold](https://en.wikipedia.org/wiki/Vladimir_Arnold) realized in 1966 that Riemannian geometry---an abstract generalization of surfaces developed by [Bernard Riemann](https://en.wikipedia.org/wiki/Bernhard_Riemann) in 1854---can be used to describe Euler's equations of hydrodynamics.
Arnold's discovery is important because it implies that our mental pictures of Riemannian geometry also guide our intuition about hydrodynamics.
A surface has curvature.
We can ask: What is the curvature of hydrodynamics?
What does it mean that hydrodynamics *has* curvature?

The discovery is of the type where two supposedly distinct areas of mathematics turn out to be related.
A mathematical equation is blind to its applications.
It's a blueprint of a perfect machine, potentially useful but with no special purpose.
Euler derived his equations, Riemann generalized geometry, and Arnold saw the former in the latter---all a century apart. 
It's fascinating.

Viviani and I asked if there are computer algorithms that approximate solutions of Euler's equations in such a way that the geometric description remains intact.
In general, computer algorithm don't preserve the geometry.
But maybe some algorithms do?
